#ifndef ForegroundPostprocessor_H
#define ForegroundPostprocessor_H
...
class ForegroundPostprocessor{

public:
	ForegroundPostprocessor();

	ForegroundPostprocessor(const Mat iniFrame);
